    ...
    <section id="contact" className={clsx(
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[1, 2, 3, 4].map((i) => (
          <motion.div
            key={i}
            animate={{ opacity: [0.6 - i * 0.1, 1, 0.6 - i * 0.1], scale: [1, 1.2 + i * 0.1, 1] }}
        ...
        >
          <input
            ...
            className={clsx(
              ...
              theme === 'dark' ? 'bg-white/5 border-white/10 text-white placeholder:text-white/50' : 'bg-white border-gray-200 text-gray-900 placeholder:text-gray-400'
            )}
          />
          <input
            type="email"
